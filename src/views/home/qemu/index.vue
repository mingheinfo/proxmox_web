      ...
      <div class="m-operate">
        ...
        <div class="m-operate-right">
          ...
          >
            ...
            <dropdown-item command="spice" name="virt-viewer" :disabled="!qemu.type || qemu.type !== 'lxc'">SPICE</dropdown-item>
            <dropdown-item command="xtermjs" name="xtermjs" :disabled="!qemu.type || qemu.type !== 'lxc'">xtermjs</dropdown-item>
          </dropdown>
          <dropdown
            style="width: auto; border:  1px solid #adb0b8; display: inline-block;padding:0px 10px;"
            @on-change="showModal"
